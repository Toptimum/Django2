...
class TestUserManagement(TestCase):
    def setUp(self):
        ...
        call_command('loaddata', 'test_db_authapp.json')
        self.client = Client()
    ...
    def test_user_login(self):
        ...
        self.assertEqual(response.context['title'], 'Главная страница магазина')
    ...
    def test_basket_login_redirect(self):
        ...
        self.assertIn('Корзина товаров', response.content.decode())
    ...
    def test_user_wrong_register(self):
        ...
        response = self.client.post('/auth/register/', data=new_user_data)
        # в случае не успешной регистрации из-за возраста мы получаем 200 ОК с выводом текста ошибки
        self.assertContains(response, 'Вы слишком молоды!', status_code=200)

        # assertFormError выводит в консоли текст ошибки и тогда тест не пройден - это вызывает сомнения
        # self.assertEqual(response.status_code, 200)
